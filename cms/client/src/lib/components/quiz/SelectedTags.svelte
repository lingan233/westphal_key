...
<div class="p-5 pt-10 h-full">
	<div class="relative custom_900:h-full rounded-3xl border-2 border-drexel-light-blue">
		<a
			class="absolute top-0 right-4 -translate-y-1/2 px-4 py-1 text-white text-sm rounded-2xl border-4 border-white {isActive ? 'bg-drexel-light-blue' : 'bg-slate-400 cursor-not-allowed'}"
			href={url}
		>
			View Results
		</a>
