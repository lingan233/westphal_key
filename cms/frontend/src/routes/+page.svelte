<a href="/quiz">
	...
	>
		<div
			class="absolute top-[50%] right-0 flex bg-drexel-dark-blue py-2 px-4 text-white w-[80%] justify-around items-center"
		>
			<h1>Tap to Explore Westphal Majors</h1>
			<img src="/svg/FingerClick.svg" alt="Finger Click Icon" />
		</div>
	</div>
</a>
